<?php
/* Smarty version 3.1.36, created on 2021-05-19 14:17:48
  from 'D:\menya_obidel_sasha\OpenServer\domains\smarty\templates\main.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_60a4f3dcafa577_78897331',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b1b22c44d6dd7fc2e9086f3ea92fe8536642c3a8' => 
    array (
      0 => 'D:\\menya_obidel_sasha\\OpenServer\\domains\\smarty\\templates\\main.tpl',
      1 => 1621423049,
      2 => 'file',
    ),
  ),
...
function content_60a4f3dcafa577_78897331 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +380931285210</a></li>
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <div class="btn-group pull-right">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default dropdown-toggle UKR" data-toggle="dropdown">
                                UKR
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a <?php if ($_smarty_tpl->tpl_vars['bas_count']->value > 0) {?>href="order.php"<?php } else { ?>href="#"<?php }?>><i class="fa fa-shopping-cart"></i>Cart <b style="color: #FF4518"><?php echo $_smarty_tpl->tpl_vars['bas_count']->value;?>
</b></a></li>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="left-sidebar">
                    <h2><a style="color: #FE980F" href="catalog.php">Category</a></h2>
...
?>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="#"> <span class="pull-right">(50)</span>One</a></li>
                                <li><a href="#"> <span class="pull-right">(56)</span>Two</a></li>
                                <li><a href="#"> <span class="pull-right">(27)</span>Three</a></li>
                                <li><a href="#"> <span class="pull-right">(32)</span>Four</a></li>
                                <li><a href="#"> <span class="pull-right">(5)</span>Five</a></li>
                                <li><a href="#"> <span class="pull-right">(9)</span>Six</a></li>
                                <li><a href="#"> <span class="pull-right">(4)</span>Seven</a></li>
                            </ul>
                        </div>
                    </div><!--/brands_products-->
            ...
            <div class="col-sm-9 padding-right" >
                              <div class="features_items"><!--features_items-->
                                    <h2 class="title text-center"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</h2>
...
<footer id="footer"><!--Footer-->
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="address">
                        ...
                        <p>bul Lesi Ukrainki 15, Kiev, Ukraine</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="single-widget">
                        <h2>Quock Shop</h2>
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="#">First field</a></li>
                            <li><a href="#">Second field</a></li>
                            <li><a href="#">Third field</a></li>
                            <li><a href="#">Gift Cards</a></li>
                            <li><a href="#">Another one field</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-2">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2020 ShiroShi. All rights reserved.</p>
